...
class Checkbox extends AbstractOptionElement
{
    /**
     * @var array
     */
    ...
    public function render()
    {
        ...
        foreach ($this->options as $value => $text) {
            ...
            echo '<label class="', $labelClass, '">', '<input id="', $this->attributes['id'], '-', $count, '"',
                $this->getAttributes(array('id', 'value', 'checked', 'required')), ' value="', $this->filter($value), '"';
